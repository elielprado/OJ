...
int main()
{
	...
	cin >> trash >> dia_i >> hora_i >> trash >> minuto_i >> trash >> segundo_i;
	cin >> trash >> dia_f >> hora_f >> trash >> minuto_f >> trash >> segundo_f;
	...
	cout << ctr_d << " dia(s)" << endl << ctr_h << " hora(s)" << endl << ctr_m << " minuto(s)" << endl << ctr_s << " segundo(s)" << endl;
